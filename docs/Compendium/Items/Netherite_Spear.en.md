...
image: /assets/textures/items/netherite_spear_gui.png
image2: /assets/textures/items/netherite_spear.png
description: | 
  ...
  **Type:** [Two Handed]  
  :material-sword: 8 Damage  
  :material-clock-fast: 1.20 Attack Speed  
  :fontawesome-solid-explosion: 2.9 Impact   
  ...
  **On second strike:**  
  :material-sword: 10 Damage  
  :fontawesome-solid-explosion: 3.48 Impact  
  :material-shield: 10% Armor Negation
  :material-target: Hit 8 Enemies per swing  
  :material-white-balance-sunny: Applies SHORT stun
description2: The Netherite Spear is a craftable weapon, of the Netherite Tier, that uses the [Spear] moveset. When swung, the Netherite Spear, utilizes the Spear swing sound  which's only present in [Spear] type weapons.
crafting: |
  <img src="/assets/textures/items/recipes/netherite_spear.png" height="400" width="400">  
    
  * 1x [Minecraft:Smithing Template]
  * 1x [Minecraft:Netherite Ingot]
  * 1x [Diamond Spear]
tips: |
