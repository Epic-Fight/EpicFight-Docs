...
title: Wooden Spear
image: /assets/textures/items/wooden_spear_gui.png
image2: /assets/textures/items/wooden_spear.png
description: | 
  ...
  **On second strike:**  
  ...
  :fontawesome-solid-explosion: 1.8 Impact  
  :material-target: Hit 8 Enemies per swing  
  :material-white-balance-sunny: Applies SHORT stun
description2: The Wooden Spear is a craftable weapon, of the Wood Tier, that uses the [Spear] moveset. When swung, the Wooden Spear, utilizes the Spear swing sound  which's only present in [Spear] type weapons.
crafting: |
  <img src="/assets/textures/items/recipes/wooden_spear.png" height="400" width="400">  
    
  * 1x [Minecraft:Wooden Sword]
  * 2x [Minecraft:Stick]
tips: |
