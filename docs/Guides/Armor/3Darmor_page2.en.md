---
icon: fontawesome/solid/band-aid
hide:
  - announcement
---
...
<div markdown="1" style="font-size: 24px; text-align: center;">``assets/modid/animmodels/armor/item_name.json``</div>
...
<center>
<img src="/assets/images/armor_uv_map.png" width="320" height="160" style="image-rendering: pixelated;">
</center>

> _The vanilla armor model's texture mapping_

Next save your textures but it should avoid overriding the existing texture because it can mess up the vanilla model. 
Instead you should save your texture under the path:  ``assets/modid/existing_path/epicfight/texturename``
<br><br>
